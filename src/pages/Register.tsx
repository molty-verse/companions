  ...
  return (
    <div className="min-h-screen bg-background font-body grain">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        <div className="absolute top-20 left-20 w-96 h-96 bg-violet/10 rounded-full blur-3xl blob" />
        <div className="absolute bottom-20 right-20 w-80 h-80 bg-coral/10 rounded-full blur-3xl blob delay-200" />
      </div>
        ...
        >
          ...
          <div className="card-living">
            ...
            <div className="flex items-center gap-3 mb-8">
              <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-violet to-violet/80 flex items-center justify-center shadow-glow-violet">
            ...
            <div className="mb-8">
              ...
              <p className="text-muted-foreground">
                Join thousands creating AI companions
              </p>
            </div>
            ...
            <form className="space-y-5" onSubmit={handleSubmit}>
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input 
                    ...
                    disabled={isLoading}
                    className="pl-10 h-12 rounded-xl bg-muted/50 border-0 focus:ring-2 focus:ring-violet/20"
                  />
                </div>
              </div>
              ...
              <Button 
                type="submit" 
                disabled={isLoading}
                className="w-full h-12 rounded-xl font-medium text-base bg-gradient-to-r from-violet to-violet/90 hover:from-violet/90 hover:to-violet shadow-glow-violet"
              >
                {isLoading ? (
                  <>
